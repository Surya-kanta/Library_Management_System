    ...
    <form>
        <table class="table-bordered" width="900px" style="text-align: center">
            ...
            <?php
                ...
                $query = "SELECT issued_books.book_name, issued_books.author_name, issued_books.book_no, users.name, issued_books.return_date FROM issued_books LEFT JOIN users ON issued_books.student_id = users.id ORDER BY issued_books.return_date ASC";
