...
<body>
    ...
    <form action="" method="post">
        <div class="container">
            ...
            <input type="text" name="book_no" value="<?php echo $book_no;?>">
...
<?php
	if(isset($_POST['update']))
	{
		...
		$query = "UPDATE books SET book_no = '$_POST[book_no]', book_name = '$_POST[book_name]', book_price = '$_POST[book_price]' WHERE book_no = '$_GET[bn]'";
		$query_run = mysqli_query($connection,$query);
        if ($query_run) {
